...
namespace auxmic.ui
{
    ...
    internal class FFmpegTool
    {
            ...
            double duration)
        {
            ...
            string queryStartInvariantCulture = queryMatchStartsAt.ToString("g", System.Globalization.CultureInfo.InvariantCulture);
            string trackStartInvariantCulture = trackMatchStartsAt.ToString("g", System.Globalization.CultureInfo.InvariantCulture);
            ...
            string exportArgs = $"-y -ss {queryStartInvariantCulture} -i \"{videoFilePath}\" -ss {trackStartInvariantCulture} -i \"{audioFilePath}\" -c copy -map 0:v:0 -map 1:a:0 -t {durationInvariantCulture} \"{targetFilePath}\"";
